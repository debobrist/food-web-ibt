---
title: "How island characteristics affect enrichment of island flora and fauna: d13C"
...
soil_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                    data = soil_dat, 
                    na.action = "na.fail",
                    REML = FALSE)

r.squaredGLMM(soil_mod) # Marginal (fixed): 0.11, conditional (inc random): 0.34

soil_dredge <- dredge(soil_mod)
soil_mods <- get.models(soil_dredge, subset = TRUE)
soil_avg <- model.avg(soil_mods, fit = TRUE) 

saveRDS(soil_avg, "soil_avg_mod-c.rds")
...
SAL_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                   data = SAL_dat, 
                   na.action = "na.fail",
                   REML = FALSE)

r.squaredGLMM(SAL_mod) # Marginal (fixed): 0.17, conditional (inc random): 0.39

SAL_dredge <- dredge(SAL_mod)
SAL_avg <- model.avg(SAL_dredge, fit = TRUE) 
saveRDS(SAL_avg, "SAL_avg_mod-c.rds")
...
FLV_dat <- df %>% 
  ...
  dplyr::mutate(ln.shoredist.std = scale(ln.shoredist)) %>% 
  dplyr::mutate(sqrt.wrack.std = scale(sqrt.wrack)) %>% 
  dplyr::filter(d13c < -16) %>% 
  dplyr::filter(d13c > -40) # These values are likely mistakes

FLV_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                   data = FLV_dat, 
                   na.action = "na.fail",
                   REML = FALSE)

r.squaredGLMM(FLV_mod) # Marginal (fixed): 0.23, conditional (inc random): 0.39

FLV_dredge <- dredge(FLV_mod)
FLV_avg <- model.avg(FLV_dredge, fit = TRUE) 
saveRDS(FLV_avg, "FLV_avg_mod-c.rds")
...
CUR_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                   data = CUR_dat, 
                   na.action = "na.fail",
                   REML = FALSE)

r.squaredGLMM(CUR_mod) # Marginal (fixed): 0.04, conditional (inc random): 0.23

CUR_dredge <- dredge(CUR_mod)
CUR_avg <- model.avg(CUR_dredge, fit = TRUE) 
saveRDS(CUR_avg, "CUR_avg_mod-c.rds")
...
ISO_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                   data = ISO_dat, 
                   na.action = "na.fail",
                   REML = FALSE)

r.squaredGLMM(ISO_mod) # Marginal (fixed): 0.14, conditional (inc random): 0.43

ISO_dredge <- dredge(ISO_mod)
ISO_avg <- model.avg(ISO_dredge, fit = TRUE) 
saveRDS(ISO_avg, "ISO_avg_mod-c.rds")
...
COL_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                   data = COL_dat, 
                   na.action = "na.fail",
                   REML = FALSE)

r.squaredGLMM(COL_mod) # Marginal (fixed): 0.07, conditional (inc random): 0.28

COL_dredge <- dredge(COL_mod)
COL_avg <- model.avg(COL_dredge, fit = TRUE) 
saveRDS(COL_avg, "COL_avg_mod-c.rds")
...
feces_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                     data = feces_dat, 
                     na.action = "na.fail",
                     REML = FALSE)

r.squaredGLMM(feces_mod) # Marginal (fixed): 0.05, conditional (inc random): 0.09

feces_dredge <- dredge(feces_mod)
feces_avg <- model.avg(feces_dredge, fit = TRUE) 
saveRDS(feces_avg, "feces_avg_mod-c.rds")
...
feather_mod <- glmmTMB(d13c ~ l.area.std * ln.shoredist.std + slope.std + sqrt.wrack.std + (1|island), 
                       data = feather_dat, 
                       na.action = "na.fail",
                       REML = FALSE)

r.squaredGLMM(feather_mod) # Marginal (fixed): 0.08, conditional (inc random): 0.08

feather_dredge <- dredge(feather_mod)
feather_avg <- model.avg(feather_dredge, fit = TRUE) 
saveRDS(feather_avg, "feather_avg_mod-c.rds")
```
...
# png("figures/diagnostics/soil-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(soil_mod), col = "grey50")
qqline(resid(soil_mod))
# dev.off()

# png("figures/diagnostics/soil-d13c-fitresid.png", units = "px", width = 600, height = 450)
...
# png("figures/diagnostics/SAL-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(SAL_mod), col = "#1B7837") 
qqline(resid(SAL_mod))
# dev.off()

# png("figures/diagnostics/SAL-d13c-fitresid.png", units = "px", width = 600, height = 450)
simulateResiduals(fittedModel = SAL_mod, plot = T)
# dev.off()

png("figures/diagnostics/SAL-d13c-hist.png", units = "px", width = 300, height = 300)
...
# Goodness of fit test
testUniformity(simulationOutput = simulated_resids) # Looks good

# Check for Outliers
testOutliers(simulationOutput = simulated_resids) # Significant but going to leave them in. They look reasonable based on this histogram:
hist(SAL_dat$d13c)
...
# png("figures/diagnostics/FLV-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(FLV_mod), col = "#7FBF7B")
qqline(resid(FLV_mod))
# dev.off()

#png("figures/diagnostics/FLV-d13c-fitresid.png", units = "px", width = 600, height = 450)
simulateResiduals(fittedModel = FLV_mod, plot = T)
# dev.off()

# png("figures/diagnostics/FLV-d13c-hist.png", units = "px", width = 300, height = 300)
...
# Check for Outliers
testOutliers(simulationOutput = simulated_resids) # These are fine. Removed problematic ones that looked like possible isotope misreads when making the FLV_dat df above.
...
# png("figures/diagnostics/CUR-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(CUR_mod), col = "#D9F0D3")
qqline(resid(CUR_mod))
# dev.off()

# png("figures/diagnostics/CUR-d13c-fitresid.png", units = "px", width = 600, height = 450)
DHARMa::simulateResiduals(fittedModel = CUR_mod, plot = T)
# dev.off()

#png("figures/diagnostics/CUR-d13c-hist.png", units = "px", width = 300, height = 300)
...
#png("figures/diagnostics/ISO-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(ISO_mod), col = "#E7D4E8")
qqline(resid(ISO_mod))
#dev.off()

#png("figures/diagnostics/ISO-d13c-fitresid.png", units = "px", width = 600, height = 450)
DHARMa::simulateResiduals(fittedModel = ISO_mod, plot = T)
# dev.off()

# png("figures/diagnostics/ISO-d13c-hist.png", units = "px", width = 300, height = 300)
...
#png("figures/diagnostics/COL-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(COL_mod), col = "#AF8DC3")
qqline(resid(COL_mod))
#dev.off()

#png("figures/diagnostics/COL-d13c-fitresid.png", units = "px", width = 600, height = 450)
DHARMa::simulateResiduals(fittedModel = COL_mod, plot = T)
#dev.off()

#png("figures/diagnostics/COL-d13c-hist.png", units = "px", width = 300, height = 300)
hist(resid(COL_mod), col = "#AF8DC3") # looks alright?
# dev.off()
...
# Goodness of fit test
testUniformity(simulationOutput = simulated_resids) # Not ideal but maybe good enough to maintain consistency with other models.
...
# png("figures/diagnostics/feces-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(feces_mod), col = "#762A83")
qqline(resid(feces_mod))
# dev.off()

# png("figures/diagnostics/feces-d13c-fitresid.png", units = "px", width = 600, height = 450)
DHARMa::simulateResiduals(fittedModel = feces_mod, plot = T)
# dev.off()

# png("figures/diagnostics/feces-d13c-hist.png", units = "px", width = 300, height = 300)
...
# Goodness of fit test
testUniformity(simulationOutput = simulated_resids) # Also not ideal but maybe good enough to maintain consistency!

# Check for Outliers
testOutliers(simulationOutput = simulated_resids) # Significant outlier test - 8 / 241 observations. 
hist(feces_dat$d13c) # They don't look super unreasonable though. Keeping them.
...
# png("figures/diagnostics/feather-d13c-qq.png", units = "px", width = 300, height = 300)
qqnorm(resid(feather_mod), col = "#762A83")
qqline(resid(feather_mod))
# dev.off()

#png("figures/diagnostics/feather-d13c-fitresid.png", units = "px", width = 300, height = 300)
DHARMa::simulateResiduals(fittedModel = feather_mod, plot = T)
# dev.off()

# png("figures/diagnostics/feather-d13c-hist.png", units = "px", width = 300, height = 300)
...
# Goodness of fit test
testUniformity(simulationOutput = simulated_resids) # Not good but keeping models the same for consistency so "good enough"! 

# Check for Outliers
testOutliers(simulationOutput = simulated_resids) # 9/337 outliers
hist(feather_dat$d13c) # That really high one might be a mistake? Not using d13c of feathers in main analysis anyways though. 
...
Feces:
```{r}
# soil_avg <- readRDS("soil_avg_mod-c.rds")
# SAL_avg <- readRDS("SAL_avg_mod-c.rds")
# FLV_avg <- readRDS("FLV_avg_mod-c.rds")
# CUR_avg <- readRDS("CUR_avg_mod-c.rds")
# ISO_avg <- readRDS("ISO_avg_mod-c.rds")
# COL_avg <- readRDS("COL_avg_mod-c.rds")
# feces_avg <- readRDS("feces_avg_mod-c.rds")
# feather_avg <- readRDS("feather_avg_mod-c.rds")
...
panel_coefplot_d13c <- ggplot(coefs_c, aes(x = taxon, y = fit, colour = taxon)) + 
  theme_bw() +
  ...
  scale_y_continuous(limits = c(-1.5, 0.52), 
                     breaks = c(-1.5, -1, -0.5, 0, 0.5)) +
  guides(color = guide_legend(reverse = TRUE)) +
  coord_flip();panel_coefplot_d13c
```
Feathers:
```{r}
# feathers: 
...
coefs_c <- rbind(soil.coefs, SAL.coefs, FLV.coefs, CUR.coefs, ISO.coefs, COL.coefs, feather.coefs)

coefs_c$taxon <- factor(coefs_c$taxon, 
...
coefs_c$parameter <- factor(coefs_c$parameter, 
                          levels = c("cond(l.area.std)", "cond(ln.shoredist.std)", "cond(l.area.std:ln.shoredist.std)", "cond(sqrt.wrack.std)", "cond(slope.std)"),
                          labels = c("Island area", "Distance to shore", "Island area * distance", "Wrack biomass", "Mean island slope"))

panel_d13c_feathers <- ggplot(coefs_c, aes(x = taxon, y = fit, colour = taxon)) + 
  theme_bw() +
  geom_hline(yintercept = 0, col = "grey50", linetype = "dashed") + 
  geom_point(size = 3) + 
  geom_errorbar(aes(ymin = (fit - 1.96 * fit.se), 
...
coefs_table <- rbind(soil.coefs, SAL.coefs, FLV.coefs, CUR.coefs, ISO.coefs, COL.coefs, feces.coefs, feather.coefs)
# write.csv(coefs_table, "d13c-coef-table.csv")
```
...
for(z in 1:length(x.a)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.a[t,1] + pars.resamp.a[t,2]*x.a[z], 0.8203048)   # add in model standard deviation
...
for(z in 1:length(x.b)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.b[t,1] + pars.resamp.b[t,2]*x.b[z], 1.584235)   # add in model standard deviation
...
for(z in 1:length(x.c)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.c[t,1] + pars.resamp.c[t,2]*x.c[z], 2.160602)   # add in model standard deviation
...
for(z in 1:length(x.d)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.d[t,1] + pars.resamp.d[t,2]*x.d[z], 0.6445153)   # add in model standard deviation
...
for(z in 1:length(x.e)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.e[t,1] + pars.resamp.e[t,2]*x.e[z], 1.106842)   # add in model standard deviation
...
for(z in 1:length(x.f)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.f[t,1] + pars.resamp.f[t,2]*x.f[z], 1.331803)   # add in model standard deviation
...
for(z in 1:length(x.g)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.g[t,1] + pars.resamp.g[t,2]*x.g[z], 1.810884)   # add in model standard deviation
...
# Calculate additional variance due to random effects & random noise: 
summary(feather_mod)
sqrt(5.473e-09 + 2.257e+00) #  1.502332
y.conf <- list() 
...
for(z in 1:length(x.h)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.h[t,1] + pars.resamp.h[t,2]*x.h[z],  1.502332)   # add in model standard deviation
...
pred.frame.a <- pred.frame.a %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.a, "soil-preds-area-d13c.csv", row.names = FALSE)

pred.frame.b <- pred.frame.b %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.b, "SAL-preds-area-d13c.csv", row.names = FALSE)


pred.frame.c <- pred.frame.c %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.c, "FLV-preds-area-d13c.csv", row.names = FALSE)


pred.frame.d <- pred.frame.d %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.d, "CUR-preds-area-d13c.csv", row.names = FALSE)


pred.frame.e <- pred.frame.e %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.e, "ISO-preds-area-d13c.csv", row.names = FALSE)


pred.frame.f <- pred.frame.f %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.f, "COL-preds-area-d13c.csv", row.names = FALSE)


pred.frame.g <- pred.frame.g %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.g, "feces-preds-area-d13c.csv", row.names = FALSE)


pred.frame.h <- pred.frame.h %>% 
  rename(l.area.std = x, d13c = m)
write.csv(pred.frame.h, "feather-preds-area-d13c.csv", row.names = FALSE)




xbreaks.area <- c(((log10(100)-mean(df$l.area) / sd(df$l.area))),
                  ((log10(1000)-mean(df$l.area) / sd(df$l.area))),
                  ((log10(10000)-mean(df$l.area) / sd(df$l.area))),
                  ((log10(100000)-mean(df$l.area) / sd(df$l.area))), 
                  ((log10(1000000)-mean(df$l.area) / sd(df$l.area))))

color_pal <- c(RColorBrewer::brewer.pal(n = 6, name = "PRGn"), "grey50")

# Feces, with PI: 
area_d13c_plot <- ggplot(NULL, aes(y = d13c, x = l.area.std)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
 ...
 geom_line(data = pred.frame.a, aes(y = d13c), colour = color_pal[7]) +
 ...
 geom_ribbon(data = pred.frame.a, aes(ymin = l.pi, ymax = u.pi), alpha = .1, linetype = 0, fill = color_pal[7]) +
  geom_line(data = pred.frame.b, aes(y = d13c), colour = color_pal[6]) +
  ...
  geom_line(data = pred.frame.c, aes(y = d13c), colour = color_pal[5]) +
  ...
  geom_line(data = pred.frame.f, aes(y = d13c), colour = color_pal[2]) +
  ...
  geom_line(data = pred.frame.g, aes(y = d13c), colour = color_pal[1]) +
  ...
  geom_line(data = pred.frame.d, aes(y = d13c), colour = color_pal[4]) +
  ...
  geom_line(data = pred.frame.e, aes(y = d13c), colour = color_pal[3]) +
...
tiff("figures/area-d13c-bootstrapped-w-PI.tiff", units = "px", res = 300, width = 1600, height = 1400)
area_d13c_plot
dev.off()

# Feces, just CI: 
area_d13c_plot2 <- ggplot(NULL, aes(y = d13c, x = l.area.std)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
...
tiff("figures/area-d13c-bootstrapped-w-CI.tiff", units = "px", res = 300, width = 1600, height = 1400)
area_d13c_plot2
dev.off()

# Feather, with PI: 
area_d13c_plot3 <- ggplot(NULL, aes(y = d13c, x = l.area.std)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
  ...
  geom_ribbon(data = pred.frame.f, aes(ymin = l.ci, ymax = u.ci), alpha = .3, linetype = 0, fill = color_pal[2]) + 
  geom_ribbon(data = pred.frame.f, aes(ymin = l.pi, ymax = u.pi), alpha = .1, linetype = 0, fill = color_pal[2]) +
  geom_line(data = pred.frame.h, aes(y = d13c), colour = color_pal[1]) +
...
tiff("figures/area-d13c-bootstrapped-w-PI-feathers.tiff", units = "px", res = 300, width = 1600, height = 1400)
area_d13c_plot3
dev.off()
...
for(z in 1:length(x.a2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.a[t,1] + pars.resamp.a[t,3]*x.a2[z],  0.8203048)   # add in model standard deviation
...
for(z in 1:length(x.b2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.b[t,1] + pars.resamp.b[t,3]*x.b2[z], 1.590503)   # add in model standard deviation
...
for(z in 1:length(x.c2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.c[t,1] + pars.resamp.c[t,3]*x.c2[z], 2.160602)   # add in model standard deviation
...
for(z in 1:length(x.d2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.d[t,1] + pars.resamp.d[t,3]*x.d2[z],  0.6445153)   # add in model standard deviation
...
for(z in 1:length(x.e2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.e[t,1] + pars.resamp.e[t,3]*x.e2[z], 1.110901)   # add in model standard deviation
...
for(z in 1:length(x.f2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.f[t,1] + pars.resamp.f[t,3]*x.f2[z],  1.331803)   # add in model standard deviation
...
for(z in 1:length(x.g2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.g[t,1] + pars.resamp.g[t,3]*x.g2[z], 1.817113)   # add in model standard deviation
...
for(z in 1:length(x.h2)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.h[t,1] + pars.resamp.h[t,3]*x.h2[z], 1.502332)   # add in model standard deviation
...
pred.frame.a2 <- pred.frame.a2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.a2, "soil-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.b2 <- pred.frame.b2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.b2, "SAL-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.c2 <- pred.frame.c2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.c2, "FLV-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.d2 <- pred.frame.d2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.d2, "CUR-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.e2 <- pred.frame.e2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.e2, "ISO-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.f2 <- pred.frame.f2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.f2, "COL-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.g2 <- pred.frame.g2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.g2, "feces-preds-dist-d13c.csv", row.names = FALSE)

pred.frame.h2 <- pred.frame.h2 %>% 
  rename(ln.shoredist.std = x, d13c = m)
write.csv(pred.frame.h2, "feather-preds-dist-d13c.csv", row.names = FALSE)
...
# Feces, with PI: 
dist_d13c_plot <- ggplot(NULL, aes(y = d13c, x = shoredist)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
  ...
  geom_point(data = CUR_dat, alpha = 0.1, colour = color_pal[4], size = 2) +
  geom_point(data = ISO_dat, alpha = 0.1, colour = color_pal[3], size = 2) +
  geom_line(data = pred.frame.a2, aes(y = d13c), colour = color_pal[7]) +
  ...
  geom_line(data = pred.frame.b2, aes(y = d13c), colour = color_pal[6]) +
  ...
  geom_line(data = pred.frame.c2, aes(y = d13c), colour = color_pal[5]) +
  ...
  geom_ribbon(data = pred.frame.c2, aes(ymin = l.pi, ymax = u.pi), alpha = .1, linetype = 0, fill = color_pal[5]) +
   geom_line(data = pred.frame.f2, aes(y = d13c), colour = color_pal[2]) +
  ...
  geom_line(data = pred.frame.g2, aes(y = d13c), colour = color_pal[1]) +
  ...
  geom_ribbon(data = pred.frame.g2, aes(ymin = l.pi, ymax = u.pi), alpha = .1, linetype = 0, fill = color_pal[1]) +
   geom_line(data = pred.frame.d2, aes(y = d13c), colour = color_pal[4]) +
  ...
  geom_line(data = pred.frame.e2, aes(y = d13c), colour = color_pal[3]) +
  ...
  ylab(expression(paste("\n"," ", delta^{13}, "C")));dist_d15n_plot

tiff("figures/dist-d13c-bootstrapped-w-PI.tiff", units = "px", res = 300, width = 1600, height = 1400)
dist_d13c_plot
dev.off()

# Feces, with CI: 
dist_d13c_plot2 <- ggplot(NULL, aes(y = d13c, x = shoredist)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
  ...
  geom_ribbon(data = pred.frame.e2, aes(ymin = l.ci, ymax = u.ci), alpha = .5, linetype = 0, fill = color_pal[3]) +
  xlab("Distance to shore (m)") +
  ylab(expression(paste("\n"," ", delta^{13}, "C")));dist_d13c_plot

tiff("figures/dist-d13c-bootstrapped-w-CI.tiff", units = "px", res = 300, width = 1600, height = 1400)
dist_d13c_plot2
dev.off()

# Feathers, with PI: 
dist_d13c_plot3 <- ggplot(NULL, aes(y = d13c, x = shoredist)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
  ...
  geom_ribbon(data = pred.frame.f2, aes(ymin = l.ci, ymax = u.ci), alpha = .3, linetype = 0, fill = color_pal[2]) +
  geom_ribbon(data = pred.frame.f2, aes(ymin = l.pi, ymax = u.pi), alpha = .1, linetype = 0, fill = color_pal[2]) +
  geom_line(data = pred.frame.h2, aes(y = d13c), colour = color_pal[1]) +
...
tiff("figures/dist-d13c-bootstrapped-w-PI-feather.tiff", units = "px", res = 300, width = 1600, height = 1400)
dist_d13c_plot3
dev.off()

# Feathers, with CI: 
dist_d15n_plot4 <- ggplot(NULL, aes(y = d13c, x = shoredist)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
...
for(z in 1:length(x.a3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.a[t,1] + pars.resamp.a[t,5]*x.a3[z],  0.8203048)   # add in model standard deviation
...
for(z in 1:length(x.b3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.b[t,1] + pars.resamp.b[t,5]*x.b3[z], 1.584235)   # add in model standard deviation
...
for(z in 1:length(x.c3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.c[t,1] + pars.resamp.c[t,5]*x.c3[z], 1.584235)   # add in model standard deviation
...
for(z in 1:length(x.d3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.d[t,1] + pars.resamp.d[t,5]*x.d3[z],  0.6445153)   # add in model standard deviation
...
for(z in 1:length(x.e3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.e[t,1] + pars.resamp.e[t,5]*x.e3[z], 1.106842)   # add in model standard deviation
...
for(z in 1:length(x.f3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.f[t,1] + pars.resamp.f[t,5]*x.f3[z],  1.331803)   # add in model standard deviation
...
for(z in 1:length(x.g3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.g[t,1] + pars.resamp.g[t,5]*x.g3[z], 1.810884)   # add in model standard deviation
...
# Calculate additional variance due to random effects & random noise: 
summary(feather_mod)
sqrt(6.966e-09 + 2.257e+00) #  1.502332
y.conf <- list() 
...
for(z in 1:length(x.h3)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.h[t,1] + pars.resamp.h[t,5]*x.h3[z], 1.502332)   # add in model standard deviation
...
pred.frame.a3 <- pred.frame.a3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.a3, "soil-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.a3 <- read.csv("soil-preds-wrack-d13c.csv")

pred.frame.b3 <- pred.frame.b3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.b3, "SAL-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.b3 <- read.csv("SAL-preds-wrack-d13c.csv")

pred.frame.c3 <- pred.frame.c3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.c3, "FLV-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.c3 <- read.csv("FLV-preds-wrack-d13c.csv")

pred.frame.d3 <- pred.frame.d3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.d3, "CUR-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.d3 <- read.csv("CUR-preds-wrack-d13c.csv")

pred.frame.e3 <- pred.frame.e3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.e3, "ISO-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.e3 <- read.csv("ISO-preds-wrack-d13c.csv")

pred.frame.f3 <- pred.frame.f3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.f3, "COL-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.f3 <- read.csv("COL-preds-wrack-d13c.csv")

pred.frame.g3 <- pred.frame.g3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.g3, "feces-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.g3 <- read.csv("feces-preds-wrack-d13c.csv")

pred.frame.h3 <- pred.frame.h3 %>% 
  rename(sqrt.wrack.std = x, d13c = m)
write.csv(pred.frame.h3, "feather-preds-wrack-d13c.csv", row.names = FALSE)
pred.frame.h3 <- read.csv("feather-preds-wrack-d13c.csv")
...
# Feces: 
wrack_d13c_plot <- ggplot(NULL, aes(y = d13c, x = sqrt.wrack)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
  ...
  ylab(expression(paste("\n"," ", delta^{13}, "C")));wrack_d13c_plot

tiff("figures/wrack-d13c-bootstrapped.tiff", units = "px", res = 300, width = 1600, height = 1400)
wrack_d13c_plot
dev.off()
```
#### Slope: 
...
for(z in 1:length(x.a4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.a[t,1] + pars.resamp.a[t,4]*x.a4[z],  0.8203048)   # add in model standard deviation
...
for(z in 1:length(x.b4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.b[t,1] + pars.resamp.b[t,4]*x.b4[z], 1.584235)   # add in model standard deviation
...
for(z in 1:length(x.c4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.c[t,1] + pars.resamp.c[t,4]*x.c4[z], 1.584235)   # add in model standard deviation
...
for(z in 1:length(x.d4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.d[t,1] + pars.resamp.d[t,4]*x.d4[z],  0.6445153)   # add in model standard deviation
...
for(z in 1:length(x.e4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.e[t,1] + pars.resamp.e[t,4]*x.e4[z], 1.106842)   # add in model standard deviation
...
for(z in 1:length(x.g4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.g[t,1] + pars.resamp.g[t,4]*x.g4[z], 1.810884)   # add in model standard deviation
...
for(z in 1:length(x.h4)){
  ...
  pred.temp <- list()
  for(t in 1:500){
    pred.temp[[t]]<- rnorm(500,pars.resamp.h[t,1] + pars.resamp.h[t,4]*x.h4[z], 1.502332)   # add in model standard deviation
...
pred.frame.a4 <- pred.frame.a4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.a4, "soil-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.a4 <- read.csv("soil-preds-slope-d13c.csv")

pred.frame.b4 <- pred.frame.b4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.b4, "SAL-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.b4 <- read.csv("SAL-preds-slope-d13c.csv")

pred.frame.c4 <- pred.frame.c4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.c4, "FLV-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.c4 <- read.csv("FLV-preds-slope-d13c.csv")

pred.frame.d4 <- pred.frame.d4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.d4, "CUR-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.d4 <- read.csv("CUR-preds-slope-d13c.csv")

pred.frame.e4 <- pred.frame.e4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.e4, "ISO-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.e4 <- read.csv("ISO-preds-slope-d13c.csv")

pred.frame.f4 <- pred.frame.f4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.f4, "COL-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.f4 <- read.csv("COL-preds-slope-d13c.csv")

pred.frame.g4 <- pred.frame.g4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.g4, "feces-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.g4 <- read.csv("feces-preds-slope-d13c.csv")

pred.frame.h4 <- pred.frame.h4 %>% 
  rename(slope.std = x, d13c = m)
write.csv(pred.frame.h4, "feather-preds-slope-d13c.csv", row.names = FALSE)
pred.frame.h4 <- read.csv("feather-preds-slope-d13c.csv")
...
# Feces:
slope_d13c_plot <- ggplot(NULL, aes(y = d13c, x = slope_mean)) +
  theme_bw() +
  theme(panel.grid = element_blank(), 
        axis.text = element_text(size = 12), 
        axis.title = element_text(size = 16)) +
...
small_plot <- ggplot(small, aes(x = d13c, y = d15n, color = taxon)) + 
  ...
  guides(color = guide_legend(override.aes = list(alpha = 1, size = 2), reverse = TRUE)) +
...
tiff("biplots-by-size-together.tiff", units = "px", width =2500, height = 1000, res = 600)
...
```
# Sources: 
Contact dobrist@sfu.ca for access to these data:
```{r}
wrack <- read.csv("wrack-isotopes.csv")
otters <- read.csv("otter-isotopes.csv")

mean(wrack$d13C) # -15.5
sd(wrack$d13C) # 2.9

mean(wrack$d15N) # 7.3
sd(wrack$d15N) # 1.0

mean(otters$X13C) # -30.1
sd(otters$X13C) # 2.1

mean(otters$X15N) # 9.6
sd(otters$X15N) # 4.2

soil <- df[df$taxon == "soil", ]
mean(soil$d15n) # 4.4
sd(soil$d15n) # 4.3

salal <- df[df$taxon == "SAL", ]
mean(salal$d15n) # -0.3
sd(salal$d15n) # 5.6
mean(salal$d13c) # -31.4
...
interact_plot(soil_mod, pred = ln.shoredist.std, modx = l.area.std)
